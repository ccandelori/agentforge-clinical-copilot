...
/**
 * InternalProblemsController — sidecar-facing read-only endpoint that
 * serves the patient's active problem list for the agent's
...
class InternalProblemsController
{
    public function __construct(
        private readonly AgentJwtValidator $validator,
        private readonly ProblemsRepository $repository,
    ) {
    }
    ...
    public function show(Request $request): Response
    {
        ...
        $problems = $this->repository->findActiveByPid($pid);
        return new JsonResponse(['problems' => $problems]);
    }
}
