...
/**
 * InternalDemographicsController — sidecar-facing read-only endpoint that
 * serves patient demographics for the agent's get_demographics tool.
 *
...
class InternalDemographicsController
{
    public function __construct(
        private readonly AgentJwtValidator $validator,
        private readonly DemographicsRepository $repository,
    ) {
    }
    ...
    public function show(Request $request): Response
    {
        ...
        try {
            $payload = $this->repository->findByPid($pid);
