...
/**
 * InternalImmunizationsController — sidecar-facing read-only endpoint
 * that serves the patient's immunization history for the agent's
 * get_immunizations tool.
 *
...
class InternalImmunizationsController
{
    public function __construct(
        private readonly AgentJwtValidator $validator,
        private readonly ImmunizationsRepository $repository,
    ) {
    }
    ...
    public function show(Request $request): Response
    {
        ...
        $immunizations = $this->repository->findByPid($pid);
        return new JsonResponse(['immunizations' => $immunizations]);
    }
}
