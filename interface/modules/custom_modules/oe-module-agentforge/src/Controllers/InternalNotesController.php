...
/**
 * InternalNotesController — sidecar-facing read-only endpoint that serves
 * the patient's recent notes (pnotes + form_clinical_notes UNION) for the
 ...
 * (default 90, clamped server-side to [1, 365]).
 *
 * @package   OpenEMR
...
class InternalNotesController
{
    ...
    public function show(Request $request): Response
    {
        ...
        $notes = $this->repository->findRecentByPid($pid, $since);
