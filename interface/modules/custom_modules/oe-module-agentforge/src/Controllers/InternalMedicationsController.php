...
/**
 * InternalMedicationsController — sidecar-facing read-only endpoint that
 * serves the patient's active medications for the agent's
...
use OpenEMR\Modules\AgentForge\Services\MedicationsRepository;
use RuntimeException;
use Symfony\Component\HttpFoundation\JsonResponse;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;

class InternalMedicationsController
{
    public function __construct(
        private readonly AgentJwtValidator $validator,
        private readonly MedicationsRepository $repository,
    ) {
    }
    ...
    public function show(Request $request): Response
    {
        ...
        $medications = $this->repository->findActiveByPid($pid);
        return new JsonResponse(['medications' => $medications]);
    }
}
