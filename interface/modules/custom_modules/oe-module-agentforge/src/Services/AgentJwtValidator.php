 ...
 *
 * MVP scope: validation returns the patient_id claim only (the single
 * authorization decision the demographics endpoint needs). Future
 * internal endpoints can extend ValidatedClaims with more fields.
 *
