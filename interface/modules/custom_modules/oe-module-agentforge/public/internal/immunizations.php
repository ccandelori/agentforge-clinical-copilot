...
/**
 * Internal endpoint: GET /agentforge/internal/immunizations?pid=N
 *
 * Called by the Python sidecar's get_immunizations tool. The sidecar
...
$controller = new InternalImmunizationsController(
    ...
    new ImmunizationsRepository($connection),
);
