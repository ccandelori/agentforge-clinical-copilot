...
/**
 * Internal endpoint: GET /agentforge/internal/procedures?pid=N[&since_days=D]
 *
 * Called by the Python sidecar's get_procedures tool. The sidecar
...
// (only forwarded when explicitly told to via mod_setenvif / CGIPassAuth /
...
$controller = new InternalProceduresController(
    ...
    new ProceduresRepository($connection, ServiceContainer::getClock()),
);
