...
/**
 * Internal endpoint: GET /agentforge/internal/vitals_trend?pid=N&since=D
 *
 * Called by the Python sidecar's get_vitals_trend tool. The sidecar
...
$controller = new InternalVitalsController(
    new AgentJwtValidator($secret, ServiceContainer::getClock()),
    new VitalsRepository($connection),
);
