...
/**
 * Internal endpoint: GET /agentforge/internal/allergies?pid=N
 *
 * Called by the Python sidecar's get_active_allergies tool. The sidecar
...
$controller = new InternalAllergiesController(
    ...
    new AllergiesRepository($connection),
);
