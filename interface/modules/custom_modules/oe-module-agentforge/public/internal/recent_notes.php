...
/**
 * Internal endpoint: GET /agentforge/internal/recent_notes?pid=N&since_days=D
 *
 * Called by the Python sidecar's get_recent_notes tool. The sidecar
...
$controller = new InternalNotesController(
    new AgentJwtValidator($secret, ServiceContainer::getClock()),
    new NotesRepository($connection),
);
