...
/**
 * Internal endpoint: GET /agentforge/internal/demographics?pid=N
 *
 * Called by the Python sidecar's get_demographics tool. The sidecar
...
use OpenEMR\Modules\AgentForge\Controllers\InternalDemographicsController;
use OpenEMR\Modules\AgentForge\EnvLoader;
use OpenEMR\Modules\AgentForge\Services\AgentJwtValidator;
use OpenEMR\Modules\AgentForge\Services\DemographicsRepository;
...
$controller = new InternalDemographicsController(
    new AgentJwtValidator($secret, ServiceContainer::getClock()),
    new DemographicsRepository($connection),
);
