...
/**
 * Internal endpoint: GET /agentforge/internal/medications?pid=N
 *
 * Called by the Python sidecar's get_active_medications tool. The sidecar
...
use OpenEMR\Modules\AgentForge\Controllers\InternalMedicationsController;
...
$controller = new InternalMedicationsController(
    new AgentJwtValidator($secret, ServiceContainer::getClock()),
    new MedicationsRepository($connection),
);
