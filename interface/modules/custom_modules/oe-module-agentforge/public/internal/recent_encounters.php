...
/**
 * Internal endpoint: GET /agentforge/internal/recent_encounters?pid=N&since_days=D
 *
 * Called by the Python sidecar's get_recent_encounters tool. The sidecar
...
$controller = new InternalEncountersController(
    new AgentJwtValidator($secret, ServiceContainer::getClock()),
    new EncountersRepository($connection),
);
