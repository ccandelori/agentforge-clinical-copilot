...
class _LabVisionExtractorLike(Protocol):
    ...
    node name stays ``intake-extractor`` for now to avoid churning the
    LangGraph wiring; rename to a neutral ``vision-extractor`` is a
    follow-up if/when more contracts land.
    """
